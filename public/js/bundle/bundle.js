...
exports.validationErrorAlert = exports.showAlert = exports.hideAlert = exports.delayAlert = void 0;
/* eslint-disable */

var delayAlert = exports.delayAlert = function delayAlert(message, type) {
...
var hideAlert = exports.hideAlert = function hideAlert(el) {
  if (el) el.remove();
};
var showAlert = exports.showAlert = function showAlert(message, type) {
  var alertPlaceholder = document.getElementById('liveAlertPlaceholder');
  var wrapper = document.createElement('div');
  wrapper.innerHTML = ["<div class=\"alert alert-".concat(type, " alert-dismissible fade show\" role=\"alert\">"), "   <div>".concat(message, "</div>"), '   <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>', '</div>'].join('');
...
var validationErrorAlert = exports.validationErrorAlert = function validationErrorAlert(error) {
  var arrValidationError = error.response.data.validationError;
  arrValidationError.forEach(function (el) {
    showAlert("".concat(error.response.data.message, ": <span class='fw-bold'>").concat(el.message, "</span>"), 'danger');
  });
};
...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"manage-data.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateDataById = exports.delDataById = exports.addNewData = void 0;
...
var addNewData = exports.addNewData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(modelName, data, form, modal) {
    var res;
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            modal.hide();
            (0, _alert.delayAlert)("Data ".concat(modelName, " berhasil ditambah"), 'success');
          }
          _context.next = 11;
          break;
        case 7:
          ...
          (0, _alert.validationErrorAlert)(_context.t0);
        case 11:
        case "end":
  ...
  return function addNewData(_x, _x2, _x3, _x4) {
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            ...
            (0, _alert.delayAlert)("Data ".concat(modelName, " berhasil diubah"), 'success');
          }
          _context2.next = 11;
          break;
        case 7:
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(modelName, objId, Modals) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          (0, _alert.delayAlert)("Data ".concat(modelName, " berhasil dihapus"), 'success');
          _context3.next = 10;
          break;
        case 7:
          _context3.prev = 7;
...
var distribusiTable = document.querySelector('#distribusi-table');
var addDistribusiForm = document.querySelector('#form-add-distribusi');
...
if (distribusiTable) {
  ...
  new _simpleDatatables.DataTable(distribusiTable, options);
}

//? Add Data Distribusi
if (addDistribusiForm) {
  var addDistribusiModal = document.querySelector('#modal-add-distribusi');
  var bsAddDistribusiModal = new bootstrap.Modal(addDistribusiModal);
  addDistribusiForm.addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    if (addDistribusiForm.checkValidity()) {
      ...
      (0, _manageData.addNewData)('distribusi', distribusiObj, addDistribusiForm, bsAddDistribusiModal);
    }
  });
}
...
if (updateDistribusiBtns.length > 0) {
  var updateDistribusiModalList = document.querySelectorAll('[id^="modal-update-distribusi"]');
  var bsUpdateDistribusiModalList = Array.from(updateDistribusiModalList).map(function (el) {
    return new bootstrap.Modal(el);
  });
  var updateDataFormList = document.querySelectorAll("[id^=\"form-update-distribusi\"]");
  updateDataFormList.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      form.classList.add('was-validated');
      var distribusiId = form.dataset.objId;
      if (form.checkValidity()) {
        ...
        (0, _manageData.updateDataById)('distribusi', distribusiId, distribusiObj, form, bsUpdateDistribusiModalList);
      }
    });
  });
}
...
if (deleteDistribusiBtns.length > 0) {
  var deleteDistribusiModalList = document.querySelectorAll('[id^="modal-delete-distribusi"]');
  var bsDeleteDistribusiModalList = Array.from(deleteDistribusiModalList).map(function (el) {
    return new bootstrap.Modal(el);
  });
  deleteDistribusiBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var distribusiId = btn.dataset.objId;
      (0, _manageData.delDataById)('distribusi', distribusiId, bsDeleteDistribusiModalList);
    });
  });
}
...
if (delayAlertMsg) {
  (0, _alert.showAlert)(delayAlertMsg, delayAlertType);
